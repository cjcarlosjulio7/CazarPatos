...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usuario = usuario.substringBefore("@") // Eliminar el dominio del correo electrónico
    ...
    //Esto se ejecuta cuando cuando se pulsa el boton home del celular
    override fun onStop() {
    ...
    //Esto se ejecuta cuando se destruye la actividad es decir se cierra la aplicación totalmente
