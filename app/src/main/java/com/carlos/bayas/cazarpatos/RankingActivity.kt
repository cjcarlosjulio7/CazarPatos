...
import com.carlos.bayas.cazarpatos.database.RankingPlayerDBHelper
...
//        jugadores.add(Player("Carlos.Bayas",10))
//        jugadores.add(Player("Jugador2",6))
//        jugadores.add(Player("Jugador3",3))
//        jugadores.add(Player("Jugador4",9))
//        jugadores.add(Player("Jugador5",2))
//        jugadores.add(Player("Jugador6",1))
//        jugadores.add(Player("Jugador7",7))
//        jugadores.add(Player("Jugador8",8))
